...
packer.startup {
    function(use)
        ...
        use {
            ...
            run = ":TSUpdate",
            event = "BufRead",
            cmd = {"TSInstall", "TSInstallInfo", "TSInstallSync", "TSUninstall", "TSUpdate", "TSUpdateSync",
        ...
        use {
            ...
            config = function()
                ...
                loader.lazy_load {
                    paths = settings.overrides.luasnip.vscode_snippets_paths
                }
                loader.lazy_load()
            end,
            requires = { -- Snippet collections
        ...
        use {
            ...
            event = "BufRead",
            cmd = {"LspInstall", "LspInstallInfo", "LspPrintInstalled", "LspRestart", "LspStart", "LspStop",
                   "LspUninstall", "LspUninstallAll"}
        }
        ...
        --     "hrsh7th/nvim-compe",
        --     setup = function()
        --         require("configs.compe-config").setup()
        --     end,
		-- 	 disable = not config.enabled.compe_config
        -- }
